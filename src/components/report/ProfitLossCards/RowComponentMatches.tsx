...
import { getSessionProfitLoss } from "../../../store/actions/user/userAction";
...
import SessionBetSeperate from "../ProfitLossReport/SessionBetSeperate";
                      ...
                      <SessionBetSeperate
                        allBetsData={
                          betProfitLossListCards
                            ? Array.from(new Set(betProfitLossListCards))
                            : []
                        }
                        betHistory={false}
